...
export function Title() {
    return <div>
        <div className='flex items-center flex-col max-w-sm w-full bg-white shadow-md rounded-lg overflow-hidden mx-auto'>
                        ...
                        <div className="space-y-6 detail_info">
                            ...
                            <div className="flex flex-col overview">
                                ...
                                <p className="text-xs text-gray-100 mb-6">
                                    ...
                                    understanding,
                                    must travel to the most dangerous planet in the universe to ensure the future of his
                                    family and his
                                    people. As
                                    malevolent forces explode into conflict over the planet's exclusive supply of the
                                    most precious
                                    resource in existence-a commodity capable of unlocking humanity's greatest
                                    potential-only those who
                                    can conquer their
                                    fear will survive.
                                </p>
                            </div>
